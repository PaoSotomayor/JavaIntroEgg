...
public class FuncionesConRetorno {
    ...
    public static void main(String[] args) {
        ...
        switch (varRespuesta) {// Para que solo muestre un resultado, segun lo que eligio el usuario. 
            case 1 -> System.out.println("LA SUMA DE LOS NUMEROS INGRESADOS ES: " + FuncionSumar(varNumero1, varNumero2));
            // Utilizo esto para cortar cuando llega a esta linea la ejecucion dentro de la estructura
            case 2 -> System.out.println("LA RESTA DE LOS NUMEROS INGRESADOS ES: " + FuncionRestar(varNumero1, varNumero2));
            case 3 -> System.out.println("LA MULTIPLICACION DE LOS NUMEROS INGRESADOS ES: " + FuncionMultiplicar(varNumero1, varNumero2));
            default -> System.out.println("INGRESO UNA OPCION INCORRECTA");
        }
        // Para que solo muestre un resultado, segun lo que eligio el usuario.
